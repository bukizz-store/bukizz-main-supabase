...
const CitySelector = () => {
  ...
  return (
    <button
      ...
      className="flex items-center space-x-2 px-3 py-1.5 md:px-4 md:py-2 border-[1.5px] border-black rounded-[2rem] hover:bg-gray-50 transition-colors bg-white whitespace-nowrap h-[46px] md:h-auto"
    >
      ...
      <div className="flex flex-col items-start justify-center leading-none space-y-0.5">
        ...
        <span className="text-base md:text-lg font-bold text-gray-900 -mt-0.5">{getCityName()}</span>
      </div>
    </button>
  );
};
