...
const Footer = () => {
  return (
    <footer className="w-full">
      ...
      {/* Desktop Footer */}
      <div className="hidden md:block bg-transparent mt-0 w-full mx-0 relative z-10">
        <div className="flex flex-col md:flex-row justify-between mb-4 mx-8 font-nunito gap-4">
          ...
          <div className="flex flex-wrap gap-8 md:gap-16">
            ...
            <div className="gap-4 flex flex-col">
              ...
              <ul className="gap-4 flex flex-col">
                <Link to="/payment-policy" className="hover:text-blue-600 cursor-pointer">Payments</Link>
                <Link to="/shipping-policy" className="hover:text-blue-600 cursor-pointer">Shipping</Link>
                <Link to="/cancellation-refund" className="hover:text-blue-600 cursor-pointer">Cancellation & Returns</Link>
              </ul>
            </div>
            <div className="gap-4 flex flex-col">
              ...
              <ul className="gap-4 flex flex-col">
                <Link to="/cancellation-refund" className="hover:text-blue-600 cursor-pointer">Cancellation & Returns</Link>
                <Link to="/terms-of-use" className="hover:text-blue-600 cursor-pointer">Terms of Use</Link>
            ...
            <div className="gap-4 flex flex-col">
              ...
              <ul className="gap-4 flex flex-col">
                ...
                <li>            <div className="flex space-x-4">
                  ...
                  <a href="https://x.com/bukizz_store?s=21" className="border border-gray-600 rounded-full p-2">
                    <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/bukizz_store?igsh=czhzNHNzbzdybHZu&utm_source=qr" className="border border-gray-600 rounded-full p-2">
                    <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Mobile Footer */}
      <div className="md:hidden block bg-transparent mt-0 md:mx-12 mx-4 relative z-10">
