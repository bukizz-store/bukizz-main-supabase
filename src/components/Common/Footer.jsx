...
const Footer = () => {
  return (
    <footer className="w-full">
      ...
      <div className="hidden md:block bg-transparent p-6 mt-0 w-full md:mx-12 mx-0 relative z-10">
        <div className="flex flex-col md:flex-row justify-between mb-4 font-nunito gap-8">
          <div>
