...
const DealsSection = () => {
  ...
  return (
    <div className="my-6 px-4 md:px-0 mx-4 md:mx-12">
      <h2 className="text-2xl md:text-4xl font-bold my-8">Deals For You</h2>
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-12 flex-1">
