      ...
      {!cart?.items || cart.items.length === 0 ? (
        ...
        <div className="flex-1 max-w-2xl mx-auto w-full">
          ...
          <div className="space-y-3 p-4">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 mb-2 flex items-start gap-3">
              ...
              <p className="text-sm text-blue-700">
                <span className="font-semibold">Free Delivery</span> on general items for orders above <span className="font-bold">₹399</span>. (Booksets excluded)
              </p>
            </div>
            {cart.items.map((item) => {
